...
// C Defaults
DEFAULTS.put("C_MIN", 0);              // Minimum a C setpoint can be
DEFAULTS.put("C_MAX", 40);             // Maximum a C setpoint can be
DEFAULTS.put("C_MIN_DEF", 22);         // Minimum setpoint default for C
DEFAULTS.put("C_MAX_DEF", 24);         // Maximum setpoint default for C
...
DEFAULTS.put("F_MIN_DEF", 70);         // Minimum setpoint default for F
DEFAULTS.put("F_MAX_DEF", 74);         // Maximum setpoint default for F
